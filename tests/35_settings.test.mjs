import { api, setup, sharedStorage } from './utils.mjs'
...
describe('API Settings Tests', () => {
  ...
  // ********** FIXME - https://github.com/certeu/morio/issues/136 - Encryption with secret tokens not working on initial deployment - BUG ********* //
  it(`Should GET /settings`, async () => {
    const jwt = sharedStorage.get('accounts.mrt')

    const result = await api.get('/settings', false, false, true, jwt)
