...
That post focused on optimising performance of the Morio nodes by replacing
...
work on this in the past, we felt that it was still too cumbersome to enrol
clients.
...
This centralised management is not yet included in this release.
...
When you do however, the client will daemonise and connect to the Kafka
