...
As you can see, this results is a more more polishes experience for the user
...
- `tools.node`: A helper method for logging that side-steps the potential logging snowball effect
...
The third and final parameter, `topic` holds the name of the topic the `data`
