...
typically a git repositoruy -- rather than keep it within Morio itself.
This allows you to deploy Morio with an _infrastructe as code_ approach.
...
At the intial setup of Morio -- and only at the initial setup -- you
...
existing Morio instance, and then add it under `preseed.keys`.

<Note>
This is an advanced feature to faciliteate  blue/green deployments
