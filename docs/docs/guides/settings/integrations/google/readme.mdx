...
- Under **App Domain**:
  - Set **Application home page** to the base URL of your Morio instance or
    cluster. For examle: `https://morio.my-company.com/`
...
- Under **Authorized domain** Add the top domain your Morio is hosted under.
...
status during which time onyl pre-defined users can use (or test) the app.
