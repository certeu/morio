...
[code.europa.eu](https://code.europa.eu/certeu/morio), a GitLab instance for
open source projects by (the administration of) the European Union.

We use a _monorepo_, which holds all the code for the Morio project.
...
<Note title="Documentation Guide">
