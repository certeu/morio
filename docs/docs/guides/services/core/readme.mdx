...
endpoint](/docs/reference/apis/core#tag/status/paths/~1status/get) is accessible to users.
...
If you are preseeding (part of) your settings, or loading things like stream
processors for the Tap service, or chart plugins for the UI through preseeding,
it is the core service that will handle this.
