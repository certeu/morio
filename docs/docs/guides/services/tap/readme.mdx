...
The tap service is build around the idea of _bring your own business logic
(BYOBL)_.
...
To learn morio about stream processing in Morio, including how to create your
