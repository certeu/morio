...
[authentication providers](/docs/guides/settings/idps).
...
Clients who enroll will do so through the API service, and they also can push
their config to, or pull their config from the API. 

This is how Morio will build up an inventory of your infrastructure over time.
