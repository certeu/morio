...
The [Morio root token provider (mrt)](/docs/guides/settings/idps/#mrt) is enabled by
...
<Label>Optional</Label> This configures [the `apikey` identity provider](/docs/guides/settings/idps/#apikey).
...
<Label>Optional</Label> This configures [the `local` identity provider](/docs/guides/settings/idps/#local).
...
This system applies to all identity providers, giving you a lot of flexibility
