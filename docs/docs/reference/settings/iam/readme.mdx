...
<h3>The Morio root token _just works_</h3>
...
<Label>Optional</Label>
Configure this if your OpenID provider does not use the default autodiscovery URL.
This is typically the case for OpenID providers that support multi-tennancy, such
