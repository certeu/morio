...
:::tip
It is a common practice to uppercase variables so they stand out in the
settings.
:::
...
- They support Morio's [Hashicorp Vault integration](/docs/guides/integrations/vault)
...
To defer to [the Hashicorp Vault integration](/docs/guides/integrations/vault),
