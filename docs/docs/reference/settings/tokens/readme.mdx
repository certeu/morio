...
- They support Morio's [Hashicorp Vault integration](/docs/guides/settings/integrations/vault)
...
To defer to [the Hashicorp Vault integration](/docs/guides/settings/integrations/vault),
