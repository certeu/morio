...
__An invite code is required to join this cluster__ - This cluster does not permit open enrollment of new clients. Only clients that present a valid invite can enroll.
