...
const Card = ({ title, ext, pkgs = [], desc, href, Icon = null, width = 'w-72' }) => (
  <div className={`${width} border px-4 pb-4 rounded shadow flex flex-col`} title={title}>
    ...
    <ul className="list list-inside list-disc ml-2 mb-4">
      {pkgs.length > 0 ? (
        ...
        <li className="opacity-50">
          No <Ext ext={ext} /> packages available
        </li>
      )}
    </ul>
    <p className="mt-2">
        ...
        <div className="max-w-4xl">
          <div className="grid grid-cols-2 gap-4 items-center justify-between items-stretch">
            <Card
              ...
              desc={
                <span>
                  Generate a <b>.deb</b> package that you can deploy on Debian-based Linux systems.
                </span>
              }
              width="w-full"
              Icon={Debian}
            ...
            <Card
              ...
              desc={
                <span>
                  Generate an <b>.rpm</b> package that you can deploy on RedHat-based Linux systems.
                </span>
              }
              width="w-full"
              Icon={RedHat}
