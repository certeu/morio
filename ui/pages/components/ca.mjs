        ...
        <div className="max-w-4xl">
          <Tabs tabs="About, Trust, Fingerprint, Certificate, Use">
            ...
            <Tab key="Trust">
              ...
              <p className="max-w-prose">
                Certificates can also be used to verify the identity of the remote party. For
                example by verifying domain ownership for a website.
              </p>
              <p className="max-w-prose">
                You should not on this CA for any verification. Instead, use your own judgement to
              ...
              <p className="max-w-prose">
                ...
                <WebLink href="/roots.pem">this CA&apos; root certificate</WebLink> as a trusted CA
                in your operating system&apos;s trust store.
              </p>
              <ul className="p-4 border rounded-lg max-w-prose ml-4 mb-4">
                <li>
                  <b>Pro:</b> Easy to do & no infrastructure requirements
                </li>
                <li>
                  <b>Con:</b> Needs to be done on every client connecting to Morio
                </li>
              </ul>
              ...
              <ul className="p-4 border rounded-lg max-w-prose ml-4 mb-4">
                <li>
                  <b>Pro:</b> Transparent to clients
                </li>
                <li>
                  <b>Con:</b> Requires an internal CA
                </li>
              </ul>
