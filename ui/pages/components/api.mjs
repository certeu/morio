          ...
          <Tabs tabs="About, Documentation">
            <Tab key="About">
              ...
              <p className="max-w-prose">
                ...
                as well as endpoints to facilitate monitoring, observability, and devops workflows.
              </p>
            </Tab>
            <Tab key="Documentation">
              <h2>API Documentation</h2>
              <p className="max-w-prose">
                The Morio Operator API provides <WebLink
                href="https://swagger.io/specification/">OpenAPI v3</WebLink> compliant documentation:
                <br />
                <a href="/ops/api/docs" target="_BLANK" className="btn btn-secondary mt-4">Open API Documentation</a>
              </p>
            </Tab>
          </Tabs>
        </div>
