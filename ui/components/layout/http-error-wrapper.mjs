...
export const HttpErrorWrapper = ({ error = 404 }) => {
  ...
  return (
    <div
      className="min-h-[100vh] w-full m-auto p-0"
      style={{
    ...
    >
      ...
      <div className="flex flex-col md:grid md:grid-cols-2 gap-2">
        <div className="bg-black bg-opacity-80 mx-auto w-full text-neutral-content">
          <div className="flex flex-col p-4 h-screen mx-auto items-end justify-between text-neutral-content px-12 py-8 gap-6">
            ...
            <div className="max-w-sm">
              <h1
                className="text-7xl bold text-neutral-content text-right block"
                style={{
                  fontSize: '6.66rem',
                }}
              >
            ...
            <a href="/" className="text-neutral-content hover:text-accent">
              <MorioWordmark />
            </a>
          </div>
        </div>
        <div
          className="hidden h-screen md:flex md:flex-col justify-end p-2"
          style={{
        ...
        >
          <span className="text-xs block w-full text-right">
