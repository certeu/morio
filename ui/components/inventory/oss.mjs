...
export const OssTable = () => {
  ...
  return (
    ...
    {Object.entries(grouped).map(([os, hosts]) => (
      <details id={os} className="bg-primary/20 p-2 rounded hover:cursor-pointer mt-4 open:bg-transparent open:border-l-4 open:rounded-none open:shadow hover:bg-primary/30 open:hover:bg-transparent open:cusor-default border-primary">
        <summary className="flex flex-row gap-2 items-center justify-between hover:cursor-pointer pr-2">
          <div className="flex flex-row gap-2 items-center">
            <RightIcon className="w-4 h-4" stroke={3}/>
            <b>{os}</b>
          </div>
