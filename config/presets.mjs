...
predocs.MORIO_API_LOG_LEVEL = 'Log level of the API service. One of trace, debug, info, warn, error, fatal, or silent'
...
predocs.MORIO_UNIT_TEST_HOST = 'Host for which to forego the https validation check. Used in unit tests only.'
...
predocs.MORIO_BROKER_LOG_LEVEL = 'Log level of the broker service. Once of all, trace, debug, info, warn, error, or fatal'
...
predocs.MORIO_INTERMEDIATE_CA_COMMON_NAME = 'Common Name (CN) for the Morio Intermediate Certificate Authority'
presets.MORIO_INTERMEDIATE_CA_COMMON_NAME = 'Morio Intermediate Certificate Authority'

predocs.MORIO_ROOT_CA_VALID_YEARS = 'Lifetime of the certificate of the Morio Root Certificate Authority'
presets.MORIO_ROOT_CA_VALID_YEARS = 20

predocs.MORIO_INTERMEDIATE_CA_VALID_YEARS = 'Lifetime of the certificate of the Morio Intermediate Certificate Authority'
presets.MORIO_INTERMEDIATE_CA_VALID_YEARS = 5

predocs.MORIO_CA_CERTIFICATE_LIFETIME_MIN = 'Minimum lifetime of a certificate generated by the Morio Certificate Authority'
presets.MORIO_CA_CERTIFICATE_LIFETIME_MIN = '5m'

predocs.MORIO_CA_CERTIFICATE_LIFETIME_MAX = 'Maximum lifetime of a certificate generated by the Morio Certificate Authority'
presets.MORIO_CA_CERTIFICATE_LIFETIME_MAX = '17544h'

predocs.MORIO_CA_CERTIFICATE_LIFETIME_DFLT = 'Default lifetime of a certificate generated by the Morio Certificate Authority'
...
predocs.MORIO_CONSOLE_PREFIX = 'URL prefix for accessing the Console service through the proxy service'
...
predocs.MORIO_CORE_CONFIG_FOLDER = 'Location of the Morio configuration folder inside the core container'
presets.MORIO_CORE_CONFIG_FOLDER = '/etc/morio'

predocs.MORIO_CORE_LOG_LEVEL = 'Log level of the API service. One of trace, debug, info, warn, error, fatal, or silent'
...
predocs.MORIO_CORE_PREFIX = 'URL prefix for accessing the _core service_ through the _proxy service_'
presets.MORIO_CORE_PREFIX = '/-/core'

predocs.MORIO_CORE_CLUSTER_HEARTBEAT_INTERVAL = 'Amount of seconds to wait between cluster heartbeats'
presets.MORIO_CORE_CLUSTER_HEARTBEAT_INTERVAL = 30

predocs.MORIO_CORE_CLUSTER_HEARTBEAT_MAX_RTT = 'Amount of milliseconds above which we start logging hearbeat latency'
...
predocs.MORIO_CORE_UUID_FINGERPRINT_LENGTH = 'Amount of characters to use for the short version (fingerprint) of a UUID'
...
predocs.MORIO_DB_RAFT_PORT = 'TCP port for the  raft consensus protocal used by the _DB service_'
...
predocs.MORIO_PROXY_LOG_LEVEL = 'Log level for the _proxy service_. One of TRACE, DEBUG, INFO, WARN, or ERROR'
presets.MORIO_PROXY_LOG_LEVEL = 'DEBUG'

predocs.MORIO_PROXY_ACCESS_LOG_FILEPATH = 'Access log filepath for Traefik inside the _proxy service_ container'
presets.MORIO_PROXY_ACCESS_LOG_FILEPATH = '/var/log/morio/traefik.access.log'

predocs.MORIO_PROXY_LOG_FILEPATH = 'Log filepath for Traefik inside the _proxy service_ container'
presets.MORIO_PROXY_LOG_FILEPATH = '/var/log/morio/traefik.log'

predocs.MORIO_PROXY_LOG_FORMAT = 'Log format for the _proxy service_. One of json or common. Common is plain text.'
...
predocs.MORIO_WATCHER_PREFIX = 'URL prefix for accessing the _watcher service_ through the _proxy service_'
...
predocs.MORIO_X509_CN = 'The default Common Name (CN) attribute for X.509 certificates generated by the _CA service_ of Morio'
presets.MORIO_X509_CN = 'Morio'

predocs.MORIO_X509_C = 'The default Country (C) attribute for X.509 certificates generated by the _CA service_ of Morio'
presets.MORIO_X509_C = 'BE'

predocs.MORIO_X509_ST = 'The default state/locality (ST) attribute for X.509 certificates generated by the _CA service_ of Morio'
presets.MORIO_X509_ST = 'Brussels'

predocs.MORIO_X509_L = 'The default Location (L) attribute for X.509 certificates generated by the _CA service_ of Morio'
presets.MORIO_X509_L = 'Brussels'

predocs.MORIO_X509_O = 'The default Organisation (O) attribute for X.509 certificates generated by the _CA service_ of Morio'
presets.MORIO_X509_O = 'CERT-EU'

// The default OU (organizational unit) attribute for X.509 certificates
predocs.MORIO_X509_OU = 'The default Orgnisational Unit (OU) attribute for X.509 certificates generated by the _CA service_ of Morio'
