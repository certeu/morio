...
// inputs and outputs
import { output as elasticsearchOutput } from './elasticsearch.mjs'
import { output as httpOutput } from './http.mjs'
import { localInput as localMorioInput, localOutput as localMorioOutput } from './morio.mjs'
/*
