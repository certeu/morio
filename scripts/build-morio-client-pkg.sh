...
cp $PKG_ROOT/../../morio-macos-arm64 $PKG_ROOT/opt/morio/bin/morio
...
cp "$PKG_BUILD/filebeat-${BEATS_VERSION}-darwin-x86_64/filebeat" "$PKG_ROOT/opt/morio/bin/"
...
cp "$PKG_BUILD/metricbeat-${BEATS_VERSION}-darwin-x86_64/metricbeat" "$PKG_ROOT/opt/morio/bin/"
...
echo "MacOS morio package built: morio-$VERSION.pkg"
